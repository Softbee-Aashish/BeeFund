...
import { faHome, faMoneyBillWave, faCalculator, faChartLine, faEnvelope } from '@fortawesome/free-solid-svg-icons';
...
const BottomNav = () => {
    const navItems = [
        ...
        { path: '/credit-report', label: 'Credit Score', icon: faChartLine },
